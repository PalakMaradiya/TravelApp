...
import com.example.travelwithme.databinding.ActivityAdminBinding
    ...
    private fun initView() {
        ...
        binding.btnSumbit.setOnClickListener {
            ...
            if (name.isEmpty()) {
                ...
                var key = reference.root.child("AdminTable").push().key ?: ""

                var modelclass = ModalClass(name, location, Description, price , key,ImageUri , rate, Day )

                reference.root.child("AdminTable").child(key).setValue(modelclass)
