...
import com.example.travelwithme.databinding.ActivityDesertDataBinding
import com.google.firebase.database.FirebaseDatabase
import com.google.firebase.storage.FirebaseStorage
import com.google.firebase.storage.StorageReference
import java.util.UUID

class DesertDataActivity : AppCompatActivity() {
    ...
    lateinit var binding : ActivityDesertDataBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDesertDataBinding.inflate(layoutInflater)
    ...
    private fun initView() {
        ...
        binding.btnSumbit.setOnClickListener {
            ...
            if (name.isEmpty()) {
                ...
                var key = reference.root.child("DesertTable").push().key ?: ""

                var modelclass = ModalClass(name, location, Description, price , key,ImageUri , rate, Day )

                reference.root.child("DesertTable").child(key).setValue(modelclass)
